...
def load_conan_dependencies():
    new_local_repository(
        name="boost",
        path="C:/Users/redacted/.conan2/p/boost3ff2a4fdb6e27/p",
        build_file="//deps/conan/conan/boost:BUILD.bazel",
    )
    new_local_repository(
        name="bzip2",
        path="C:/Users/redacted/.conan2/p/bzip2c02b42bf08110/p",
        build_file="//deps/conan/conan/bzip2:BUILD.bazel",
    )
    new_local_repository(
        name="zlib",
        path="C:/Users/redacted/.conan2/p/zlib47a1fa7d4bdbe/p",
